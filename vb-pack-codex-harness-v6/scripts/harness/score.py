#!/usr/bin/env python3
"""Score v6 harness readiness against the 9.5 operating target."""
...
def score() -> dict:
    ...
    checks = {
        ...
        "release_gate": command_ok([sys.executable, "scripts/harness/release_gate.py", "--template"]),
        "intent_router_gate": command_ok([sys.executable, "scripts/harness/intent_router_gate.py", "--template"]),
        "domain_language_gate": command_ok([sys.executable, "scripts/harness/domain_language_gate.py", "--template"]),
        "spec_gate": command_ok([sys.executable, "scripts/harness/spec_gate.py", "--template"]),
        "req_evidence_gate": command_ok([sys.executable, "scripts/harness/req_evidence_gate.py", "--template"]),
        "team_rule_mining_gate": command_ok([sys.executable, "scripts/harness/team_rule_mining_gate.py", "--template"]),
        "rule_promotion_gate": command_ok([sys.executable, "scripts/harness/rule_promotion_gate.py", "--template"]),
        "spec_drift_gate": command_ok([sys.executable, "scripts/harness/spec_drift_gate.py", "--template"]),
