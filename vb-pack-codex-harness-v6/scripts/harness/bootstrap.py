#!/usr/bin/env python3
"""Initialize or adopt a Codex Harness v6 template."""
...
DEFAULT_RUNTIME = {
    ...
    "default_adoption_profile": "intent-routed-spec-evidence",
    "default_tier": "normal",
    "state_root": "harness",
    ...
    "gates": {
        ...
        "intent_router_gate": "normal",
        "domain_language_gate": "domain",
        "spec_gate": "behavior",
        "req_evidence_gate": "normal",
        "team_rule_mining_gate": "team",
        "rule_promotion_gate": "learning",
        "spec_drift_gate": "review",
    },
    "v6_focus": {
        "purpose": "Natural-language intent-routed Codex harness with spec and evidence validation.",
