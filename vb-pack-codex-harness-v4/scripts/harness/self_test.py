#!/usr/bin/env python3
"""Structural self-test for Codex Harness v4."""
...
def main() -> int:
    ...
    try:
        ...
        if runtime.get("framework_version") != "v4":
            errors.append("runtime framework_version must be v4")
        if runtime.get("default_adoption_profile") != "creative-daily":
            errors.append("runtime default_adoption_profile must be creative-daily")
    except Exception as exc:
