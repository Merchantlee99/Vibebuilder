...
For v3 `production` profile, mirror this directory outside the local workspace through GitHub Actions artifacts, a private backup repository, or external object storage. Local hash chains do not survive full-folder deletion.
