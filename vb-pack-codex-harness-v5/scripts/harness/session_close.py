...
def main() -> int:
    ...
    commands = [
        ...
        ["scripts/harness/simplicity_gate.py", "--artifact-dir", args.artifact_dir],
        ["scripts/harness/design_gate.py", "--artifact-dir", args.artifact_dir],
    ...
    if args.template:
        ...
        commands[2].append("--template")
        commands[3].append("--template")
    if args.review_file:
