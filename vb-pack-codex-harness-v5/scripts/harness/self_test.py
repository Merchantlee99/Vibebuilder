#!/usr/bin/env python3
"""Structural self-test for Codex Harness v5."""
...
def main() -> int:
    ...
    try:
        ...
        if runtime.get("default_adoption_profile") != "implementation-first-evidence":
            errors.append("runtime default_adoption_profile must be implementation-first-evidence")
